...
\noindent 
Minor and Major Arcs, Sectors and Segments:

\bigskip 

\noindent
Assume that $O$ is the centre of the circle. 

\bigskip 

\includegraphics[width=0.35\textwidth]{110.png}

\bigskip 

\includegraphics[width=0.35\textwidth]{111.png}

\bigskip 

\includegraphics[width=0.35\textwidth]{112.png}

\bigskip

\noindent
Area of Common Figures, Perimeter, Arc Length, Sector Area, Segment Area:
...
\includegraphics[width=0.48\textwidth]{81.png}

\bigskip
Relation between hollow cone and sector:

\includegraphics[width=0.45\textwidth]{113.png}
...
\noindent 
Scale Factor, $k=\frac{\text { Length of side of image }}{\text { Length of corresponding side of object }}$

\noindent 
(i) When the scale factor $k$ is such that $k>1$, the image produced is enlarged, i.e. size of image $>$ size of object.

\noindent 
(ii) When the scale factor $k$ is such that $0<k<1$, the image produced is diminished, i.e. size of image $<$ size of object.

\noindent 
(iii) When the scale factor $k=1$, the image is the same size as object, i.e. both the image and the corresponding object are congruent.
...
\noindent 
1. Bearing is measured from the North in a clockwise direction.

\noindent 
2. Bearing ranges from $0^{\circ}$ to $360^{\circ}$.

\noindent 
3. Bearing is written as a 3-digit number in degrees, e.g. $060^{\circ}, 290^{\circ}, 009^{\circ}, 032.1^{\circ}$ (to 1 decimal place if necessary).
...
\section*{Geometric Properties of Circles}
...
\noindent 
(a) If a line drawn from the centre of a circle bisects a chord, the line is perpendicular to the chord.

\noindent 
(b) If a line drawn from the centre of a circle is perpendicular to a chord, the line bisects the chord.

\includegraphics[width=0.45\textwidth]{120.png}
...
\includegraphics[width=0.45\textwidth]{121.png}

\bigskip 

\noindent
3. Tangent is perpendicular to radius:

\bigskip  

\noindent 
Tangents to a circle are perpendicular to the radii of the circle at the points of contact.

\includegraphics[width=0.25\textwidth]{122.png}

\bigskip 

\noindent
4. Equal Tangents from Exterior Point:

\bigskip  

\noindent 
Tangents from $A$ and $B$ drawn to a common exterior point $P$ are equal in length.

\includegraphics[width=0.3\textwidth]{123.png}

\begin{itemize}
	\item $AP = BP$ by the property of Equal Tangents from Exterior Point.

\item $\angle OAP = \angle OBP  = 90^\circ$ because tangents are perpendicular to radii at their respective points of tangency.

\item Observe also that $OA=OB$ because they are the radii of the circle. 

\item Hence by either the SSS or the RHS congruency test, $\triangle AOP$ is congruent to $\triangle BOP$.
\end{itemize} 

\noindent 
Using the above results, we can deduce also that:

\begin{itemize}
\item $OP$ bisects the angle $\angle APB$.
\item $OP$ bisects the angle $\angle AOB$. 
\item $\angle OPA = \angle OPB$.
\item $\angle AOP = \angle BOP$.
\end{itemize} 

\bigskip

\noindent 
5. $\angle$ at Centre $=2 \angle$ at Circumference

\includegraphics[width=0.48\textwidth]{140.png}

\noindent 
An angle at the centre of a circle is twice that of any angle at the circumference subtended by the same arc.
...
\includegraphics[width=0.48\textwidth]{150.png}
...
\noindent 
7. Right angle in semicircle

\includegraphics[width=0.25\textwidth]{151.png}

\noindent 
The angle at the circumference subtended by a diameter of a circle is $90^\circ$.

\bigskip

\noindent 
8. $\angle$ s in Opp. Segments (opp. $\angle$ s of Cyclic Quad)

\includegraphics[width=0.25\textwidth]{152.png}

\noindent 
If a quadrilateral is a cyclic quadrilateral, then the opposite angles in the quadrilateral are supplementary
