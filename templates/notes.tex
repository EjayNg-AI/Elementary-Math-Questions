...
1. Two pairs of equal adjacent sides\\
...
5. The diagonals bisect the interior angles at the vertices, so that $\angle A B D = \angle C B D$ and $\angle A D B = \angle C D B$ \\
